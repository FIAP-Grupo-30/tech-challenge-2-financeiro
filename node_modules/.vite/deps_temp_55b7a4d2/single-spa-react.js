...
function a(e2, t2) {
  ...
  }(t2))) throw Error("single-spa's dom-element-getter-helpers was given an invalid domElementGetter for application or parcel '".concat(t2.name, "'. Expected a function, received ").concat(r(n2)));
  return function() {
    var e3 = n2(t2);
    if (!(e3 instanceof HTMLElement)) throw Error("single-spa's dom-element-getter-helpers: domElementGetter returned an invalid dom element for application or parcel '".concat(t2.name, "'. Expected HTMLElement, received ").concat(r(e3)));
    return e3;
  };
}
var c = null;
...
var u = { React: null, ReactDOM: null, ReactDOMClient: null, rootComponent: null, loadRootComponent: null, renderType: "createRoot", errorBoundary: null, errorBoundaryClass: null, domElementGetter: null, parcelCanUpdate: true, suppressComponentDidCatchWarning: false, domElements: {}, renderResults: {}, updateResolves: {}, unmountResolves: {} };
function i(e2) {
  if ("object" !== n(e2)) throw new Error("single-spa-react requires a configuration object");
  var o2 = t(t({}, u), e2);
  if (!o2.React) throw new Error("single-spa-react must be passed opts.React");
  if (!o2.ReactDOM && !o2.ReactDOMClient) throw new Error("single-spa-react must be passed opts.ReactDOM or opts.ReactDOMClient");
  if (!o2.rootComponent && !o2.loadRootComponent) throw new Error("single-spa-react must be passed opts.rootComponent or opts.loadRootComponent");
  if (o2.errorBoundary && "function" != typeof o2.errorBoundary) throw Error("The errorBoundary opt for single-spa-react must either be omitted or be a function that returns React elements");
  !c && o2.React.createContext && (c = o2.React.createContext()), o2.SingleSpaRoot = function(e3) {
    function t2(e4) {
  ...
  var r2 = { bootstrap: s.bind(null, o2), mount: p.bind(null, o2), unmount: l.bind(null, o2) };
  return o2.parcelCanUpdate && (r2.update = m.bind(null, o2)), r2;
}
function s(e2, t2) {
